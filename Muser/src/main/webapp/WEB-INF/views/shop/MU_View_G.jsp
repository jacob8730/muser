                                ...
                                <div class="container" >
                                    ...
                                    <div class="card">
                                        <div class="card-body" width="500px";> 
                                            <form name="reviewCommentForm" class="row" action="<c:url value='/shop/reviewInsert'/>" method="POST">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10">
                                                    <p>
                                                        <c:choose>
                                                    	<c:when test="${member ne null}">
                                                        <a class="float-left"><textarea cols='90' rows='5' name='reviewDesc' style="resize: none;"></textarea></a>
                                                        </c:when>
                                                        <c:otherwise>
                                                        <a class="float-left"><textarea cols='90' rows='5' name='reviewDesc' style="resize: none;" readonly="readonly">로그인 후 이용가능한 서비스 입니다.</textarea></a>
                                                        </c:otherwise>
                                                        </c:choose>
                                            ...
                                            <form class="card card-inner" id="rvModifyForm" action="<c:url value='/shop/reviewModify'/>" method="post">
                                                <div class="card-body">
                                                <c:forEach var="rvList" items="${list}">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="https://image.ibb.co/jw55Ex/def_face.jpg" class="img img-rounded img-fluid"/>
                                                            <p class="text-secondary text-center">${rvList.muId}</p>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <p>
                                                            ...
                                                            <c:choose>
                                                              ...
                                                              <b><c:out value='${rvList.stars}'/>점</b>
                                                              
                                                              </div>
                                                              <c:choose>
                                                              <c:when test="${member.muId eq rvList.muId}">
                                                          		<a class="float-left"><textarea cols='90' rows='5' name='reviewDesc' style="resize: none;font-size: 16px;">${rvList.reviewDesc}</textarea></a>		
                                                       		</c:when>
                                                       		<c:otherwise>
                                                       		<a class="float-left"><textarea cols='90' rows='5' name='reviewDesc' style="resize: none;font-size: 16px;" readonly="readonly">${rvList.reviewDesc}</textarea></a>
                                                       		</c:otherwise>
                                                       		</c:choose>
                                                        <span class="float-right"><i class="text-warning fa fa-star"></i></span>
                                                        </p>
                                                        <font id="DeleteFont" color="red" size="2"> </font>
                                                            	<c:if test="${member.muId eq rvList.muId}">
                                                ...
                                                <script>
                                                	function ReviewDelete(){
                                                		if(confirm('정말 삭제하시겠습니까?')){
                                                			$.ajax({
                                                				type:'GET',
                                                				url:'<c:url value="/shop/ReviewDelete"/>',
                                                				data: {"reviewNo":"${rvList.reviewNo}"},
