        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                ...
                <br>
                <div class="U_Edge">
                <form name="bUpdateForm" action="<c:url value='/board/boardModify?boardNo=${dto.boardNo}'/>" method="post" enctype="multipart/form-data">
                  	<input type="hidden" id="FILE_NO" name="FILE_NO" value=""> 
                  	<input type="hidden" id="fileNoDel" name="fileNoDel[]" value=""> 
					<input type="hidden" id="fileNameDel" name="fileNameDel[]" value=""> 
                  <div class="U_From">
                    <h3 class="U_Text"><c:out value='${dto.muId}'/>님의 게시글 수정하기</h3>
                  </div>
                      ...
                      <div class=" col-md-17 col-lg-17 "> 
                        <table class="table table-user-information">
                          <tbody>
                            ...
                            <tr>
                              <td>제목</td>
                              <td id="Content_title"><input type="text" name="boardTitle" value="${dto.boardTitle}"></td>
                            </tr>
                            <tr>
                                <td> </td>
                                <td> </td>
                            ...
                            <tr>
                                <td>내용</td>
                              	<td><textarea name="boardDesc" style="width:100%; resize:none; height:400px;"><c:out value='${dto.boardDesc}'/></textarea></td>
                            </tr>
                        ...
                        <!-- <a href="./Write_List" class="btn-primary1">돌아가기</a> -->
                        <button class="site-btn" id="ContentRemove" onclick="BoardDelete()">삭제하기</button>
                        <!-- <a href="./BoardDelete" class="btn-primary1">삭제하기</a> -->
                        <button class="site-btn"  id="ContentModify">글 수정</button>
                        
                        <!-- <a href="./U_B_Modify" class="btn-primary1">게시글 수정하기</a> -->
                        </center>
                      </div>
                    </div>
                  </div>
