                    ...
                    <div class="mask flex-center">
                      <div class="container">
                        <div class="row align-items-center">
                            <a style="text-align: center;"><a href="https://www.naver.com/" target="_blank" ><img src="../resources/img/room/Room_View_B4.png"alt="slide"  style=" width:3000px; bottom: 0px;"></a></a>                   </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="mask flex-center">
                      <div class="container">
                        <div class="row align-items-center">
                            ...
                            <a style="text-align: center;"><a href="https://www.naver.com/" target="_blank" ><img src="../resources/img/room/Room_View_B5.png"alt="slide"  style=" width:3000px;"></a></a>                   </div>
                      </div>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="mask flex-center">
                      <div class="container">
                        <div class="row align-items-center"> 
                            <a style="text-align: center;"><a href="https://www.naver.com/" target="_blank" ><img src="../resources/img/room/Room_View_B6.png"alt="slide"  style=" width:3000px;"></a></a>                   </div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="content-wrapper">	
                <div class="item-container">	
                    <div class="container">	
                            ...
                            <div class="container service1-items col-sm-2 col-md-2 pull-left">
                                <center>
                                    ...
                                    <a id="item-1" class="service1-item">
                                        <img src="../resources/img/room/Room4.png" alt="" style="margin-left: -60px;"></img>
                                    </a>
                                    <a id="item-2" class="service1-item">
                                        <img src="../resources/img/room/Room5.png" alt="" style="margin-left: -60px;"></img>
                                    </a>
                                    <a id="item-3" class="service1-item">
                                        <img src="../resources/img/room/Room6.png" alt="" style="margin-left: -60px;"></img>
                                    </a>
                        ...
                        <div class="col-md-7">
                            <br><br>
                            <div class="product-title"><h2>Rehearsal Studio : 합주실</h2></div>
                            ...
                            <hr>
                            <br><br>
                            <div class="product-price"><h2>H : 13,000원 </h2></div>
                    ...
                    <div class="col-md-12 product-info">
                        ...
                        <div id="myTabContent" class="tab-content">
                                <div class="tab-pane fade in active" id="service-one">
                                 <center>
                                    <img src="../resources/img/room/View_Room2.png"alt=""></img><!-- 기타 상세보기 -->
                                </center>                 
                                </div>
