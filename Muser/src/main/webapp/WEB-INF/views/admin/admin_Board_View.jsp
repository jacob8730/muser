                  ...
                  <div class="panel-body">
                      ...
                      <div class=" col-md-9 col-lg-9 "> 
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>제목</td>
                              <td><c:out value='${dto.boardTitle}'/></td>
                            </tr>
                            <tr>
                                <td> </td>
                                <td> </td>
                            ...
                            <tr>
                                <td>내용</td>
                              	<td><textarea name="boardDesc" style="width:100%; resize:none; height:300px;" readonly><c:out value='${dto.boardDesc}'/></textarea></td>
                            </tr>
                        ...
                        <center class="mt-7">
                        <div>
                        	<button class="site-btn"  id="AdminBoardList" onclick="location.href='<c:url value="/admin/admin_Board"/>'">돌아가기</button>
                       		<button class="site-btn" id="AdminBoardRemove" onclick="BoardDelete()">삭제하기</button>
                        </div>
                        </center>
                      </div>
                    </div>
              					...
              					function BoardDelete() {
              						...
              						$.ajax({
              							...
              							success:function(result){
              								...
              								$("#AdminBoardRemove").hide();
              								window.location.href='<c:url value="/admin/admin_Board"/>';
