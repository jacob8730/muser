                ...
                <main>
                    ...
                    <div class="container">
                        ...
                        <div class="card mb-4">
                         ...
                         <form action="<c:url value='/admin/admin_Shop_List'/>">
                           <select name="Search">
                              <option value="CateSearch"<c:out value="${Search eq 'CateSearch' ? 'selected':''}"/>>카테고리</option>
                              <option value="NameSearch"<c:out value="${Search eq 'NameSearch' ? 'selected':''}"/>>상품명</option>
                           </select>
                     ...
                     <script>
						...
						$(document).on('click', 'a[href="#"]', function(e){
                            ...
                            <div class="card-body">
                                ...
                                <form name="form1" id="form1" method="post" action="<c:url value='/admin/admin_Shop_Update'/>">
                                 ...
                                 <tr style="text-align:center;">
                                    ...
                                    <td>${gList.gdsDate}</td>
                                    <td>
				                        <input class="qty-input form-group" type="number" name="amount" min="1" value="${gList.gdsAmount}"
				                        	 style="text-align: center; width: 100px; height: 40px; border: 1px solid #eeeeee"/>  
				                        <input type="hidden" name="gdsNo" value="${gList.gdsNo}">
				                      </td>
									<%-- <td>${gList.gdsAmount}</td> --%>
									<td><fmt:formatNumber value="${gList.gdsPrice}" pattern="###,###,###"></fmt:formatNumber></td>
                                    <td><button class="btn btn-dark btn-sm" type="submit">확인</button></td>   
                                    <td><button class="btn btn-dark btn-sm" type="button" onclick="location.href='<c:url value="/admin/admin_Shop_Delete?gdsNo=${gList.gdsNo}"/>'">삭제</button></td>   
                                 </tr>
                                 </c:forEach>
                                    </table>
                                    ...
                                    <script>
									 function list(page) {
										location.href="${pageContext.request.contextPath}/admin/admin_Shop_List?curPage="+page+
