        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">연습실 관리</div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container">
                        <h1 class="mt-4">연습실 관리</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">관리자</li>
                            <li class="breadcrumb-item active">연습실 리스트</li>
                        </ol>
                        <div class="card mb-4">
                        ...
                        <form action="<c:url value='/admin/admin_Room_List'/>">
                           <select name="Search">
                              <option value="NameSearch"<c:out value="${Search eq 'NameSearch' ? 'selected':''}"/>>업주</option>
                           </select>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                 ...
                                 <tr style="text-align:center;">
                                    <th>NO</th>
                                    <th>업주</th>
                                    <th class="col-md-5" style="width:750px;">주소</th>
                                    <th>등록일</th>
                                    <th>삭제</th>
                                 </tr>
                                 </thead>
                                 ...
                                 <tr style="text-align:center;">
                                 	<td>${rList.ofNo}</td>
                                    <td>${rList.repName}</td>
                                    <td class="col-md-5" style="width:750px; text-align:left;">${rList.ofAddr1}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${rList.ofAddr2}&nbsp;&nbsp;${rList.ofAddr3}</td>
                                    <td>${rList.ofDate}</td>
                                    <td><button class="btn btn-dark btn-sm" type="button" onclick="location.href='<c:url value="/admin/admin_Room_Delete?ofNo=${rList.ofNo}"/>'">삭제</button></td>
                                 </tr>
                                 </c:forEach>
                                    </table>
                                   <script>
									 function list(page) {
										location.href="${pageContext.request.contextPath}/admin/admin_Room_List?curPage="+page+
