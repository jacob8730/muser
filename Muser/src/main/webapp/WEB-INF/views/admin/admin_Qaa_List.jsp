            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container">
                        ...
                        <form action="<c:url value='/admin/admin_Qaa_List'/>">
                           <select name="Search">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                 ...
                                 <tr style="text-align:center;">
                                 	<th>No</th>
                                    <th>ID</th>
                                    <th class="col-md-2" style="width:650px;">제목</th>
                                    <th>등록일</th>
                                    <!-- <th>조회수</th> -->
                                 </tr>
                                 
                                 <c:forEach var="qList" items="${list}">
                                 <%-- <c:if test="${member.muId==qList.muId}">  --%>
                                 <tr style="text-align:center;">
                                 	<td>${qList.qnaNo}</td>
                                    <td>${qList.muId}</td>
                                    <td class="col-md-2" style="width:650px;"><a href="<c:url value='/admin/admin_Qaa_View?qnaNo=${qList.qnaNo}'/>">
                                    	${qList.qnaTitle}</a></td>
                                    <td>${qList.qnaDate}</td>
                                  <%--   <td>${bList.bHits}</td>   --%> 
                                 </tr>
                                <%--  </c:if> --%>
                                    ...
                                    <script>
									 function list(page) {
										location.href="${pageContext.request.contextPath}/admin/admin_Qaa_List?curPage="+page+
