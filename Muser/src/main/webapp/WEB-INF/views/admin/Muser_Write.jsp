										...
										<div class="admin_content_main">
											<form action="/admin/goodsEnroll" method="post"
												...
												<div class="form_section">
													...
													<div class="form_section_content">
														<input name="publisher"> <span
															class="ck_warn publisher_warn">회사를 입력해주세요.</span>
													</div>
												</div>
												...
												<div class="form_section">
													...
													<div class="form_section_content">
														<div class="cate_wrap">
															<span>제품 선택</span> <select class="cate1">
																<option selected value="none">기타</option>
																<option selected value="none">피아노</option>
																<option selected value="none">드럼</option>
																<option selected value="none">베이스</option>
															</select>
														</div>
												...
												<div class="form_section">
													...
													<div class="form_section_content">												
														<input type="file" name="publeYear" autocomplete="off" readonly="readonly"> 
